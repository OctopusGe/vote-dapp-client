    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-form-item">
          ...
          <input v-model="nickName" type="text" name="organizationName" id="LAY-user-login-nickname" lay-verify="nickName" placeholder="昵称" class="layui-input">
        </div>
